...
{ 
	...
	public void set()
	{
		...
		if(question==0)
		{
			l16.setText("1) select a valid statement ?");
			r[0].setText("char[] ch=new char(5)");
			r[1].setText("char[] ch=new char[5]");
			r[2].setText("char[] ch=new char()");
			r[3].setText("char[] ch=new char[]");
		}
		if(question==1)
		{
			l16.setText("2) What is the extension of java code files ?");
			r[0].setText(" .js");
			r[1].setText(".txt");
			r[2].setText(".class");
			r[3].setText(".java");
		...
		if(question==2)
		{
			l16.setText("3) Which of the following is not an OOPS concept in Java ?");
			r[0].setText("Polymorphism");
			r[1].setText("Inheritance");
			r[2].setText("Compilation");
			r[3].setText("Encapsulation");
		}
		if(question==3)
		{
			l16.setText("4) Which of these are selection statements in Java ?");
			r[0].setText("break");
			r[1].setText("continue");
			r[2].setText("for()");
			r[3].setText("if()");
		}
		if(question==4)
		{
			l16.setText("5) Which one of the following is not an access modifier ?");
			r[0].setText("Protected");
			r[1].setText("void");
			r[2].setText("public");
			r[3].setText("private");
		}
